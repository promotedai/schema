...
class _IdentifierProvenanceEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_IdentifierProvenance.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
    UNKNOWN: IdentifierProvenance.ValueType = ...  # 0
    NULL: IdentifierProvenance.ValueType = ...  # 1
    """Set to null by platform code."""

    EMPTY: IdentifierProvenance.ValueType = ...  # 2
    """Set to the empty string by platform integration code."""

    AUTOGENERATED: IdentifierProvenance.ValueType = ...  # 3
    """Automatically generated by metrics library."""

    PLATFORM_SPECIFIED: IdentifierProvenance.ValueType = ...  # 4
...
class _CohortArm:
    ValueType = typing.NewType('ValueType', builtins.int)
    V: typing_extensions.TypeAlias = ValueType
class _CohortArmEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_CohortArm.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
    UNKNOWN_GROUP: CohortArm.ValueType = ...  # 0
    CONTROL: CohortArm.ValueType = ...  # 1
    TREATMENT: CohortArm.ValueType = ...  # 2
    TREATMENT1: CohortArm.ValueType = ...  # 3
    """These are generic arms (groups) that can be used when there are multiple treatments."""

    TREATMENT2: CohortArm.ValueType = ...  # 4
    TREATMENT3: CohortArm.ValueType = ...  # 5
...
class _ImpressionSourceType:
    ValueType = typing.NewType('ValueType', builtins.int)
    V: typing_extensions.TypeAlias = ValueType
class _ImpressionSourceTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ImpressionSourceType.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
    UNKNOWN_IMPRESSION_SOURCE_TYPE: ImpressionSourceType.ValueType = ...  # 0
    DELIVERY: ImpressionSourceType.ValueType = ...  # 1
    """Content was served by Promoted Delivery API."""

    CLIENT_BACKEND: ImpressionSourceType.ValueType = ...  # 2
...
class _ActionTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ActionType.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
    UNKNOWN_ACTION_TYPE: ActionType.ValueType = ...  # 0
    CUSTOM_ACTION_TYPE: ActionType.ValueType = ...  # 1
    """Action that doesn't correspond to any of the below."""

    NAVIGATE: ActionType.ValueType = ...  # 2
    """Navigating to details about content."""

    ADD_TO_CART: ActionType.ValueType = ...  # 4
    """Adding an item to shopping cart."""

    REMOVE_FROM_CART: ActionType.ValueType = ...  # 10
    """Remove an item from shopping cart."""

    CHECKOUT: ActionType.ValueType = ...  # 8
    """Going to checkout."""

    PURCHASE: ActionType.ValueType = ...  # 3
    """Purchasing an item."""

    SHARE: ActionType.ValueType = ...  # 5
    """Sharing content."""

    LIKE: ActionType.ValueType = ...  # 6
    """Liking content."""

    UNLIKE: ActionType.ValueType = ...  # 9
    """Un-liking content."""

    COMMENT: ActionType.ValueType = ...  # 7
    """Commenting on content."""

    MAKE_OFFER: ActionType.ValueType = ...  # 11
    """Making an offer on content."""

    ASK_QUESTION: ActionType.ValueType = ...  # 12
    """Asking a question about content."""

    ANSWER_QUESTION: ActionType.ValueType = ...  # 13
    """Answering a question about content."""

    COMPLETE_SIGN_IN: ActionType.ValueType = ...  # 14
    """Complete sign-in.
    No content_id needed.  If set, set it to the Content's ID (not User).
    """

    COMPLETE_SIGN_UP: ActionType.ValueType = ...  # 15
    """Complete sign-up.
    No content_id needed.  If set, set it to the Content's ID (not User).
    """
...
class IdentifierProvenances(google.protobuf.message.Message):
    ...
    user_id_provenance: global___IdentifierProvenance.ValueType = ...
    log_user_id_provenance: global___IdentifierProvenance.ValueType = ...
    session_id_provenance: global___IdentifierProvenance.ValueType = ...
    view_id_provenance: global___IdentifierProvenance.ValueType = ...
    auto_view_id_provenance: global___IdentifierProvenance.ValueType = ...
    insertion_id_provenance: global___IdentifierProvenance.ValueType = ...
    impression_id_provenance: global___IdentifierProvenance.ValueType = ...
    action_id_provenance: global___IdentifierProvenance.ValueType = ...
    content_id_provenance: global___IdentifierProvenance.ValueType = ...
    request_id_provenance: global___IdentifierProvenance.ValueType = ...
    def __init__(self,
        *,
        user_id_provenance : global___IdentifierProvenance.ValueType = ...,
        log_user_id_provenance : global___IdentifierProvenance.ValueType = ...,
...
class CohortMembership(google.protobuf.message.Message):
    ...
    arm: global___CohortArm.ValueType = ...
    """Optional."""
...
class View(google.protobuf.message.Message):
    ...
    class _ViewTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ViewType.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
        UNKNOWN_VIEW_TYPE: View.ViewType.ValueType = ...  # 0
        WEB_PAGE: View.ViewType.ValueType = ...  # 1
        APP_SCREEN: View.ViewType.ValueType = ...  # 2
    ...
    use_case: proto.delivery.delivery_pb2.UseCase.ValueType = ...
    """Optional."""
    ...
    def locale(self) -> proto.common.common_pb2.Locale:
        """Optional."""
        pass
    view_type: global___View.ViewType.ValueType = ...
...
class Impression(google.protobuf.message.Message):
    ...
    source_type: global___ImpressionSourceType.ValueType = ...
    """Optional."""
