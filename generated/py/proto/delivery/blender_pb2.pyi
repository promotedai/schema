...
class TermConditionalEvaluation(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["boolean",b"boolean","equal",b"equal","eval_method",b"eval_method","greater_than",b"greater_than","interval",b"interval","less_than",b"less_than","sparse_id_match",b"sparse_id_match"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["attribute_name",b"attribute_name","boolean",b"boolean","equal",b"equal","eval_method",b"eval_method","greater_than",b"greater_than","hashed_attribute",b"hashed_attribute","interval",b"interval","less_than",b"less_than","sparse_id_match",b"sparse_id_match","value_if_false",b"value_if_false"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["eval_method",b"eval_method"]) -> typing.Optional[typing_extensions.Literal["boolean","equal","greater_than","less_than","interval","sparse_id_match"]]: ...
