...
class PositiveRule(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"_max_pos",b"_max_pos"]) -> typing.Optional[typing_extensions.Literal["max_pos"]]: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"_min_pos",b"_min_pos"]) -> typing.Optional[typing_extensions.Literal["min_pos"]]: ...
    @typing.overload
...
class NegativeRule(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"_forbid_greater_pos",b"_forbid_greater_pos"]) -> typing.Optional[typing_extensions.Literal["forbid_greater_pos"]]: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"_forbid_less_pos",b"_forbid_less_pos"]) -> typing.Optional[typing_extensions.Literal["forbid_less_pos"]]: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"_max_count",b"_max_count"]) -> typing.Optional[typing_extensions.Literal["max_count"]]: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"_min_spacing",b"_min_spacing"]) -> typing.Optional[typing_extensions.Literal["min_spacing"]]: ...
    @typing.overload
...
class QualityScoreTerm(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"_fetch_high",b"_fetch_high"]) -> typing.Optional[typing_extensions.Literal["fetch_high"]]: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"_fetch_low",b"_fetch_low"]) -> typing.Optional[typing_extensions.Literal["fetch_low"]]: ...
    @typing.overload
