...
class Timing(google.protobuf.message.Message):
    ...
    EVENT_API_TIMESTAMP_FIELD_NUMBER: builtins.int
    LOG_TIMESTAMP_FIELD_NUMBER: builtins.int
    client_log_timestamp: builtins.int = ...
    event_api_timestamp: builtins.int = ...
    log_timestamp: builtins.int = ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"client_log_timestamp",b"client_log_timestamp",u"event_api_timestamp",b"event_api_timestamp",u"log_timestamp",b"log_timestamp"]) -> None: ...
