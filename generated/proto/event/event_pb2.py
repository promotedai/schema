...
_ANCESTORIDHISTORY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='ancestor_id_history', full_name='event.AncestorIdHistory.ancestor_id_history', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LOGREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='mobile_diagnostics', full_name='event.LogRequest.mobile_diagnostics', index=11,
...
_ANCESTORIDHISTORY.fields_by_name['ancestor_id_history'].message_type = _ANCESTORIDHISTORYITEM
...
_LOGREQUEST.fields_by_name['mobile_diagnostics'].message_type = _MOBILEDIAGNOSTICS
